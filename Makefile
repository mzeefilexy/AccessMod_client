#############################################################################
# Makefile for building: accessmodClient.app/Contents/MacOS/accessmodClient
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Dec 12 13:21:47 2014
# Project:  accessmodClient.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile accessmodClient.pro
#############################################################################
...
SOURCES       = accessmodClient.cpp 
OBJECTS       = accessmodClient.o
DIST          = /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		...
		accessmodClient.pro
QMAKE_TARGET  = accessmodClient
DESTDIR       = 
TARGET        = accessmodClient.app/Contents/MacOS/accessmodClient
...
all: Makefile accessmodClient.app/Contents/PkgInfo accessmodClient.app/Contents/Resources/empty.lproj accessmodClient.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) accessmodClient.app/Contents/MacOS/ || $(MKDIR) accessmodClient.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: accessmodClient.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/clang.conf \
	...
	$(QMAKE) -o Makefile accessmodClient.pro
...
accessmodClient.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) accessmodClient.app/Contents || $(MKDIR) accessmodClient.app/Contents 
	@$(DEL_FILE) accessmodClient.app/Contents/PkgInfo
	@echo "APPL????" >accessmodClient.app/Contents/PkgInfo
accessmodClient.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) accessmodClient.app/Contents/Resources || $(MKDIR) accessmodClient.app/Contents/Resources 
	@touch accessmodClient.app/Contents/Resources/empty.lproj
	
accessmodClient.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) accessmodClient.app/Contents || $(MKDIR) accessmodClient.app/Contents 
	@$(DEL_FILE) accessmodClient.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,accessmodClient,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >accessmodClient.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/accessmodClient1.0.0 || $(MKDIR) .tmp/accessmodClient1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/accessmodClient1.0.0/ && $(COPY_FILE) --parents accessmodClient.cpp .tmp/accessmodClient1.0.0/ && (cd `dirname .tmp/accessmodClient1.0.0` && $(TAR) accessmodClient1.0.0.tar accessmodClient1.0.0 && $(COMPRESS) accessmodClient1.0.0.tar) && $(MOVE) `dirname .tmp/accessmodClient1.0.0`/accessmodClient1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/accessmodClient1.0.0
...
distclean: clean
	-$(DEL_FILE) -r accessmodClient.app
	-$(DEL_FILE) Makefile
...
accessmodClient.o: accessmodClient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o accessmodClient.o accessmodClient.cpp
