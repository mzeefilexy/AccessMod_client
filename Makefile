...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Dec 12 13:15:36 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/accessmodClient1.0.0/ && $(COPY_FILE) --parents accesmod.cpp .tmp/accessmodClient1.0.0/ && (cd `dirname .tmp/accessmodClient1.0.0` && $(TAR) accessmodClient1.0.0.tar accessmodClient1.0.0 && $(COMPRESS) accessmodClient1.0.0.tar) && $(MOVE) `dirname .tmp/accessmodClient1.0.0`/accessmodClient1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/accessmodClient1.0.0
